...
const Socials = () => {
  const handleResume = () =>{
    const pdfUrl = "https://drive.google.com/file/d/1d49b4HndYjiOGZintf0QuPhp5afGixtH/view?usp=sharing"
  ...
  return (
    <div className='flex justify-between w-screen items-center px-12 py-12 mt-40'>
      ...
      <div className="flex justify-center gap-8 ">
        <button className="bg-black text-white py-2 px-4 rounded-xl h-[40px] hover:bg-gray-700" onClick={handleResume} target="_blank">Resume</button>
        <a href="mailto:mishrasidhant01@gmail.com" className="bg-black text-white py-2 px-4 rounded-xl h-[40px] hover:bg-gray-700">
          Email
        </a>
      </div>
