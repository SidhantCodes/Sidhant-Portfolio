    ...
    <section id='contact' className='mt-60 mb-36'>
      <div className={`flex flex-col px-12 w-screen items-center`}>
        ...
        <div className={`flex gap-5 mt-1`}>
          <a href="https://github.com/SidhantCodes" target="_blank"><motion.img whileHover={{ scale: [null, 1.1, 1.1] }} src={githubO} alt="" className={`h-[35px] w-[35px]`} /></a>
          <a href="https://www.linkedin.com/in/smishra0110/" target="_blank"><motion.img whileHover={{ scale: [null, 1.1, 1.1] }} src={linkedinO} alt="" className={`h-[35px] w-[35px]`} /></a>
          <a href="mailto:mishrasidhant01@gmail.com"><motion.img whileHover={{ scale: [null, 1.1, 1.1] }} src={mail} alt="" className={`h-[35px] w-[35px]`} /></a>
        </div>
      </div>
